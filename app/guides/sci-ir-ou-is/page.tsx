...
const FAQS = [
  {
    q: "L'option pour l'IS est-elle vraiment irrévocable ?",
    a: "Oui, définitivement. Une SCI qui opte pour l'IS ne peut plus revenir à l'IR, même en cas de changement de projet ou de cession des parts. C'est la principale précaution à prendre avant de basculer.",
  },
  {
    q: "Une SCI à l'IR peut-elle louer en meublé ?",
    a: "Non. La location meublée est considérée comme commerciale. Une SCI qui fait de la location meublée habituelle bascule automatiquement à l'IS, même sans l'avoir demandé. Pour de la location meublée, une autre structure (SARL de famille à l'IR, par exemple) est généralement préférable.",
  },
  {
    q: "Dans quels cas l'IS est-il intéressant ?",
    a: "Quand vous voulez amortir comptablement le bien (déduction fiscale du prix d'acquisition), éviter l'imposition personnelle des loyers au barème progressif, et accepter la double imposition en cas de distribution de dividendes. Typique : grosses opérations locatives professionnelles, SCI familiales patrimoniales long terme.",
  },
  {
    q: "Quel impact sur la plus-value à la revente ?",
    a: "À l'IR, la plus-value est calculée selon le régime des particuliers, avec abattement progressif aboutissant à une exonération complète au bout de 22 ans (IR) et 30 ans (prélèvements sociaux). À l'IS, la plus-value est taxée à l'impôt sur les sociétés sur la base de la différence entre le prix de vente et la valeur comptable — or, comme le bien a été amorti, la valeur comptable peut être très basse, ce qui peut entraîner une plus-value très élevée.",
  },
  {
    q: "Peut-on créer une SCI sans option dès la constitution ?",
    a: "Oui, et c'est même le cas par défaut. Les statuts peuvent toutefois prévoir l'option pour l'IS dès le départ — au même moment que la constitution — si vous avez déjà fait l'arbitrage. À défaut, vous pouvez opter ultérieurement dans les conditions fixées par l'article 239 du Code général des impôts.",
  },
];
    ...
    <>
      ...
      >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-slate-700">
                <Row a="Imposition des loyers" b="Revenus fonciers, barème progressif + prélèvements sociaux" c="IS : 15 % jusqu'à 42 500 €, puis 25 %" />
                <Row a="Amortissement du bien" b="Non (impossible en revenus fonciers)" c="Oui, déductible du résultat chaque année" />
                <Row a="Déduction des charges" b="Limitée au régime des revenus fonciers" c="Toutes charges réelles liées à l'exploitation" />
                <Row a="Distribution aux associés" b="Loyers répartis automatiquement selon quote-parts" c="Dividendes distribués au choix du gérant, avec PFU de 30 %" />
                <Row a="Plus-value à la revente" b="Régime des particuliers (abattement à partir de la 6e année, exonération à 22 ans IR / 30 ans PS)" c="Différence entre prix de vente et valeur comptable amortie, taxée à l'IS" />
                <Row a="Déficit" b="Imputable sur les revenus fonciers du foyer, plafonné à 10 700 € par an" c="Reportable sans limitation sur les bénéfices futurs de la société" />
                <Row a="Location meublée" b="Impossible — bascule automatique à l'IS" c="Autorisée" />
                <Row a="Réversibilité" b="L'option IS est définitive" c="L'option IS est définitive" />
              </tbody>
            </table>
          </div>
        </GuideSection>
        ...
        <GuideSection title="Cas où l'IS devient pertinent">
          <p>
            L&apos;IS s&apos;impose dans des configurations spécifiques :
          </p>
          <ul className="list-disc pl-6 space-y-2 marker:text-slate-400">
            <li>
